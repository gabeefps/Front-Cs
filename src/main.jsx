...
function Produtos() {
  ...
  return <>
    <Panel title="Catálogo de produtos" desc={apiOnline ? "Gerencie os produtos da sua loja." : "Backend offline. Inicie a API para gerenciar produtos reais."}>
  ...
  return <div className="requestsPage">
    ...
    <div className="requestsGrid">
      <section className="requestsListPanel">
        <div className="requestsHeader"><div><h3>Central da Loja</h3><p>{apiOnline ? "Acompanhe as solicitações recebidas pela loja." : "Backend offline. Ligue a API para puxar do banco."}</p></div><button className="ghost small"><Filter size={16}/> Filtros</button></div>
        ...
        <div className="requestCards">
          {loading && <div className="emptyRequests"><MessageSquareText size={30}/><strong>Carregando pedidos...</strong><p>Buscando solicitações.</p></div>}
...
function Financeiro() {
  ...
  return <>
    ...
    <div className="mainGrid">
    <Panel title="Fluxo financeiro" desc="Acompanhe as entradas e saídas de cada dia.">
